                ...
                <li class="hoge-item">
                    <a href="" class="hoge-item-link">
                        ...
                        <div class="hoge-item-body">
                            <div class="hoge-item-title">洋館の名前</div>
                            <div class="hoge-item-text">洋館の説明</div>
                        </div>
                    </a>
                </li>
                <li class="hoge-item">
                    <a href="" class="hoge-item-link">
                        <div class="hoge-item-picture"><img src="https://image.jimcdn.com/app/cms/image/transf/none/path/s801baca4fdd4a1c3/image/i99629c914f61d576/version/1524213874/image.jpg" alt=""></div>
                        <div class="hoge-item-body">
                            <div class="hoge-item-title">洋館の名前</div>
                            <div class="hoge-item-text">洋館の説明</div>
                        </div>
